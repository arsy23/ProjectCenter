...
function GetDefaultAutoMapperPackages(
...
function GetDefaultApplicationLayerAutoMapperPackages(
    [Parameter(Mandatory =  $true)]
    [hashtable]
    $HashtableToAppend
)  {
...
function GetDefaultInfrastructureLayerAutoMapperPackages(
    [Parameter(Mandatory =  $true)]
    [hashtable]
    $HashtableToAppend
)  {
...
function GetDefaultEfCoreSqlPersistenceLayerAutoMapperPackages(
    [Parameter(Mandatory =  $true)]
    [hashtable]
    $HashtableToAppend
)  {
